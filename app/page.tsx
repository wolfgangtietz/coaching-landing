  ...
  return (
    <main className="min-h-screen">
        ...
        <div className="max-w-5xl mx-auto space-y-24">
          <Reveal delay={200}>
            <div className="grid md:grid-cols-3 gap-16">
              <div>
                <span className="block text-zinc-600 mb-4 text-sm tracking-widest uppercase">01</span>
                <h3 className="text-2xl font-light mb-2">Klarheit</h3>
                <p className="text-zinc-500 font-light">Wahrheit jenseits der Erwartungen finden.</p>
              </div>
              <div>
                <span className="block text-zinc-600 mb-4 text-sm tracking-widest uppercase">02</span>
                <h3 className="text-2xl font-light mb-2">Neuausrichtung</h3>
                <p className="text-zinc-500 font-light">Strategischer Fokus für neue Etappen.</p>
              </div>
              <div>
                <span className="block text-zinc-600 mb-4 text-sm tracking-widest uppercase">03</span>
                <h3 className="text-2xl font-light mb-2">Aktivierung</h3>
                <p className="text-zinc-500 font-light">Wirksamkeit durch authentisches Handeln.</p>
              </div>
            </div>
          </Reveal>
        </div>
      ...
      <section className="py-32 px-6 max-w-3xl mx-auto">
        <Reveal delay={300}>
          <div className="mb-16">
            <h2 className="text-zinc-500 text-sm tracking-[0.2em] uppercase mb-8">Autorität</h2>
          ...
          <div className="space-y-6">
            <p className="text-2xl font-light leading-relaxed">
              Seit über fünfzehn Jahren begleite ich Führungskräfte in Phasen der Transformation. 
              Mein Ansatz verbindet systemische Tiefe mit radikaler Sachlichkeit. 
              Ich arbeite ausschließlich mit Klienten, die bereit sind, ihre Rolle als Mittel, nicht als Ziel zu begreifen.
            </p>
          </div>
        </Reveal>
      </section>
      ...
      <section className="py-32 px-6">
        <div className="max-w-5xl mx-auto">
          <h2 className="text-3xl font-light mb-16 text-center">Case Studies</h2>
